        ...
        <>
            ...
            <div className="md:hidden fixed top-0 left-0 w-full bg-white shadow-md flex items-center justify-between p-4 z-50">
                ...
                <Link href="/" className="flex items-center" >
                    <img src="https://i.postimg.cc/BQBG3N8G/logo.png"alt="AsekKey" className="h-8 "  />
                </Link>
            </div>
            ...
            >
                ...
                <Link href="/" className="block ">
                    <img src="https://i.postimg.cc/BQBG3N8G/logo.png" alt="AsekKey Logo" className="h-24" />
                </Link>
                ...
                <nav>
                    <ul>
                        ...
                        <SidebarLink href="/" label="Mes offres" active={pathname === '/'} icon={BriefcaseIcon} />
